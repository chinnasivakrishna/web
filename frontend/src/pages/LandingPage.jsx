        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <motion.div
              ...
              className="pt-8 border-t border-slate-200/80 dark:border-slate-800/80 grid grid-cols-3 gap-4"
            >
              <div>
              ...
              <div>
                <p className="text-2xl sm:text-3xl font-black text-brand-600 dark:text-brand-400">95%</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                ...
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
                  <h4 className="text-xl font-bold text-slate-900 dark:text-white">50+</h4>
                  <p className="text-xs text-slate-500">Corporate Hiring Partners</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3 text-xs font-semibold text-slate-700 dark:text-slate-300">
                ...
                <span>support@stuvaradhi.com</span>
              </div>
              <div className="flex items-center gap-3 text-xs font-semibold text-slate-700 dark:text-slate-300">
