  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <SEO 
        ...
        description="Register for a student account on StuVaradhi. Apply for industry-aligned course bootcamps, hands-on internships, and placement prep."
        keywords={['student registration', 'StuVaradhi sign up', 'apply online course', 'coding bootcamp apply']}
      />
